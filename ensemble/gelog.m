...
% Test single cycle
%
start_time = datenum(2024,10,05,18,0,0);
end_time   = datenum(2024,10,10,06,0,0);
stnum_f = '14';
basin_f = 'AL';
%
times_all = start_time:0.25:end_time;
%
for alltimes = times_all
    [yr,mo,da,hr,mn,sc] = datevec(alltimes);
    yr_f = num2str(yr);
    if (mo < 10)
        mo_f = ['0' num2str(mo)];
    else
    ...
    clear yr mo da hr mn sc vmax* time_bt tline  prob_f fid date_f basin_bt
    disp(['Working on time ' mo_f '/' da_f '/' hr_f ' in year ' yr_f])
    ...
    for ti = 1:nt
        ...
        %
        if ti == 1
            feat_ind_log = [4 31 34 38 43 54 55];
        elseif ti == 2
            feat_ind_log = [4 31 34 38 43 54 55];
        elseif ti == 3
            feat_ind_log = [4 31 34 38 43 54 55];
        elseif ti == 4
            feat_ind_log = [4 31 34 38 54 55];
        elseif ti == 5
            feat_ind_log = [3 4 31 34 38 54 55];
        elseif ti == 6
            feat_ind_log = [3 4 31 34 38 54 55];
        elseif ti == 7
            feat_ind_log = [3 4 31 34 54 55];
        elseif ti == 8
            feat_ind_log = [3 4 31 34 54 55];
        elseif ti == 9
            feat_ind_log = [3 4 31 34 54 55];
        elseif ti == 10
            feat_ind_log = [4 31 34 41 54 55];
        elseif ti == 11
            feat_ind_log = [4 31 34 41 54 55];
        elseif ti == 12
            feat_ind_log = [4 31 34 41 54 55];
        ...
        elseif ti == 18
            feat_ind_log = [4 31 34 41 54 55];
        elseif ti == 19
            feat_ind_log = [3 4 31 34 41 54 55];
        elseif ti == 20
            feat_ind_log = [3 4 31 34 41 54 55];
        elseif ti == 21
